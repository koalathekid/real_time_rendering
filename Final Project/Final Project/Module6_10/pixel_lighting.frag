...
void main()
{
	...
	vec4 color;
	 ...
	 if (usebumpmap == 1) //use bumpmapping
     {
		 
		  n = texture2D(bumpmapunit, texture).rgb;
		  n = normalize(n * 2.0 - 1.0);
		  //n = normalize(TBN * n); Here for proof of concept for creating more realistic bump mapping
